...
- **Scales**: `scales`, `scale-area`, `scale-binned`, `scale-binned-area`, `scale-brewer`, `scale-continuous`, `scale-date`, `scale-datetime`, `scale-discrete`, `scale-distiller`, `scale-fermenter`, `scale-gradient`, `scale-gradient2`, `scale-gradientn`, `scale-grey`, `scale-hue`, `scale-identity`, `scale-log10`, `scale-manual`, `scale-okabe-ito`, `scale-radius`, `scale-reverse`, `scale-sqrt`, `scale-steps`, `scale-steps2`, `scale-stepsn`, `scale-time`, `scale-viridis-b`, `scale-viridis-c`, `scale-viridis-d`, `dup-axis`, `sec-axis`, `breaks-pretty`, `breaks-quantile`, `breaks-width`, `brewer-palette`, `okabe-ito`, `colour-mix`, `expand-limits`.
