...
///
/// \@param nrow Number of rows when laying out levels in a grid; `none` for default. Applies to discrete (swatch) and continuous `size` scale legends; a continuous colourbar is a single bar and ignores it.
///
/// \@param ncolumn Number of columns when laying out levels in a grid; `none` for default. Applies to discrete (swatch) and continuous `size` scale legends; a continuous colourbar is a single bar and ignores it.
///
