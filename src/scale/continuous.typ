...
// train.typ, and accepted `oob` modes, mirrored by `_check` in oob.typ. Validated
// here so a typo fails at construction rather than silently no-opping downstream.
