...
///   : a guide spec from \@guide-legend for the `{}` aesthetic, `none` to hide it, or
///   `auto` for the default.
/// \@param default a fallback guide whose unset fields (e.g. an `auto` `position`) are
