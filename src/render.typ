...
#import "scale/train.typ": (
  all-aesthetics, map-axis, map-axis-data, map-continuous, map-position,
  mapping-display-name, positional-aesthetics, train, transform-inv,
)
...
#import "utils/margin.typ": (
  opposite-side, perpendicular-sides, resolve-margin-side-rel-cm,
)
